...
Original file is located at
    https://colab.research.google.com/drive/1JqmVHyEXi3Jq6lxgQUKIU4FAnv_E_PhX
"""
...
# 레시피 데이터 읽어오기
recipe = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/크롤링/curry_recipe.csv', index_col = 'id')
